            ...
            <div className="space-y-4 sm:space-y-6">
              {contactInfo.map((info) => (
                <motion.a
                  ...
                  href={info.href}
                  whileHover={{ x: 10 }}
                  className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-white dark:bg-gray-700 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200"
                >
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center space-x-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:shadow-lg transition-shadow duration-300"
              >
                <Send size={20} />
